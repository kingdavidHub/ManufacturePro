        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent>
                          <SelectItem value="item16">Item 16</SelectItem>
                          <SelectItem value="item24">Item 24</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage />
                    </FormItem>
            ...
            <div className="flex justify-end space-x-4 mt-8">
              <Button type="button" variant="outline" onClick={() => router.push("/orders/view")}>
                Discard
              </Button>
